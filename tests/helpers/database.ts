...
export async function createTestDatabase() {
  ...
  return {
    ...
    client,
    async reset() {
      await client`truncate table presentation_items, presentation_sessions, question_sequence_sessions, audit_events, auth_throttles, pin_reset_grants, admin_sessions, participant_sessions, answers, questions, avatar_assignments, participants, admin_accounts, events restart identity cascade`;
    },
