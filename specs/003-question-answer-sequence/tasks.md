...
- [X] T005 T004의 스키마 변경, 기존 질문의 순서 backfill, 네 답변 가능 질문 허용과 새 인덱스를 `db/migrations/0003_question_answer_sequence.sql` 및 `db/migrations/meta/_journal.json`에 추가한다
