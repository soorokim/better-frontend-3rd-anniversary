...
## Answer Flow Local Validation Record (2026-08-30)
...
- 실제 PostgreSQL을 쓰는 T038~T039, 360px 브라우저 T040, 앱 컨테이너 재시작 뒤 지속성은
  로컬 테스트 데이터베이스가 없어 아직 실행하지 않았다. 운영 데이터와 분리된 테스트
  데이터베이스에서 이 세 검증을 마쳐야 T047과 Scenario 3 전체를 완료로 표시할 수 있다.
