...
export default async function AnswersPage() {
  ...
  if (!archive) return <main className="game-shell"><GamePanel title="Archive Locked"><p>진행자가 모든 답을 공개하면 여기서 함께 다시 볼 수 있어요.</p><Link className="memory-back-link" href="/lobby">로비로 돌아가기</Link></GamePanel></main>;
